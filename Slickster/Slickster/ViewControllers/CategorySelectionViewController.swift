...
class CategorySelectionViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate {
    ...
    var filtered: [YelpCategory] = []
    var categories: [YelpCategory]? = nil
    
    var templateType:String? = nil
    var activityType:String? = nil
    
    var commitSelectedCategory:Bool = false
    var selectedCategory:YelpCategory? = nil
    var selectableCategories:[YelpCategory]? = nil
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if !searchActive {
            selectedCategory = categories![indexPath.row] as YelpCategory
        } else {
            selectedCategory = filtered[indexPath.row] as YelpCategory
        }
        ...
        if(testCell != nil) {
            ...
            delegate?.categorySelectionViewController(self, didSelectCategory: selectedCategory)
        }
    }
