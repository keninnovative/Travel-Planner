...
class EventbriteSubCategorySelectionViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate {
    ...
    var filtered: [EventbriteSubCategory] = []
    var categories: [EventbriteSubCategory]? = nil
    
    var templateType:String? = nil
    var activityType:String? = nil
    
    var commitSelectedCategory:Bool = false
    var selectedCategory:EventbriteSubCategory? = nil
    var selectableCategories:[EventbriteSubCategory]? = nil
    
    var delegate: EventbriteSubCategorySelectionViewControllerDelegate?
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if !searchActive {
            selectedCategory = categories![indexPath.row] as EventbriteSubCategory
        } else {
            selectedCategory = filtered[indexPath.row] as EventbriteSubCategory
        }
        ...
        if(testCell != nil) {
            ...
            delegate?.eventBriteSubCategorySelectionViewController(self, didSelectCategory: selectedCategory)
        }
    }
